use pylight::{SymbolIndex, Symbol, SymbolKind};
...
fn test_index_add_file() {
    ...
    let symbols = vec![
        Symbol::new("func1".to_string(), SymbolKind::Function, path.clone(), 1, 0),
...
fn test_index_update_file() {
    ...
    // Add initial symbols
    let symbols_v1 = vec![
        Symbol::new("old_func".to_string(), SymbolKind::Function, path.clone(), 1, 0),
    ];
    index.add_file(path.clone(), symbols_v1).unwrap();
    
    // Update with new symbols
    let symbols_v2 = vec![
        Symbol::new("new_func".to_string(), SymbolKind::Function, path.clone(), 1, 0),
        Symbol::new("NewClass".to_string(), SymbolKind::Class, path.clone(), 10, 0),
    ];
...
fn test_index_remove_file() {
    ...
    let symbols1 = vec![
        Symbol::new("func1".to_string(), SymbolKind::Function, path1.clone(), 1, 0),
    ];
    let symbols2 = vec![
        Symbol::new("func2".to_string(), SymbolKind::Function, path2.clone(), 1, 0),
    ];
